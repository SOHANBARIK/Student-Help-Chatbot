...
st.set_page_config(page_title="SohanAI Chatbot", layout="centered")
...
# User input box
user_input = st.text_input("", placeholder="Message SohanAI...", key="chat_input", help="Type your message here.")
